    ...
    <!--        <div class="span12 columns">-->
              ...
              <table class="table table-responsive table-striped table-bordered table-condensed">
                <thead>
                  <tr>
                    ...
                    <th class="red header">View/Edit</th>
                ...
                <tbody>
                  ...
                  foreach($products as $row)
                  {
                    ...
                    echo '<td class="crud-actions">';
                    echo '<a href="'.site_url("admin").'/products/delete/'.$row['id'].'" class="btn btn-danger">delete</a>';  
                    echo '</td>';  
                    echo '</tr>';
                  }
                  ?>      
              ...
              <?php echo '<nav>'.$this->pagination->create_links().'</nav>'; ?>
